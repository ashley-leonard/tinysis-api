...
ActiveRecord::Schema.define(version: 20_190_914_171_321) do
  ...
  create_table 'contracts', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=latin1', force: :cascade do |t|
    ...
    t.index %w[facilitator_id category_id term_id], name: 'index_contracts_on_fac_cat_term'
  ...
  create_table 'learning_plans', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=latin1', force: :cascade do |t|
    ...
    t.datetime 'created_at', default: '1900-01-01 00:00:00', null: false
    t.datetime 'updated_at', default: '1900-01-01 00:00:00', null: false
    t.index %w[user_id year], name: 'index_learning_plans_on_user_id_and_year'
  end
  ...
  create_table 'notes', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=latin1', force: :cascade do |t|
    ...
    t.index %w[notable_type notable_id], name: 'index_notes_on_notable'
  ...
  create_table 'statuses', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=latin1', force: :cascade do |t|
    ...
    t.index %w[statusable_id statusable_type month], name: 'index_statuses_on_statusable_and_month', unique: true
    t.index %w[statusable_type statusable_id], name: 'index_status_on_statusable'
  end
  ...
  create_table 'turnins', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=latin1', force: :cascade do |t|
    ...
    t.index %w[enrollment_id assignment_id], name: 'index_turnins_on_enrollment_id_and_assignment_id', unique: true
  ...
  create_table 'users', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=latin1', force: :cascade do |t|
    ...
    t.index %w[date_active date_inactive], name: 'index_users_on_active_dates'
