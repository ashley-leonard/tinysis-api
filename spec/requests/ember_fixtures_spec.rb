...
RSpec.describe 'Ember fixtures script', type: :request do
  before(:each) do
    travel_to Date.new(CURRENT_YEAR, 11, 15) do
      ...
      @term1_last = create :term, name: Faker::Company.catch_phrase, school_year: LAST_YEAR, credit_date: Date.new(LAST_YEAR + 1, 1, 31)
      @term2_last = create :term, name: Faker::Company.catch_phrase, school_year: LAST_YEAR, credit_date: Date.new(LAST_YEAR + 1, 6, 15)
      @term1_current = create :term, name: Faker::Company.catch_phrase, school_year: CURRENT_YEAR, credit_date: Date.new(CURRENT_YEAR + 1, 1, 31)
      @term2_current = create :term, name: Faker::Company.catch_phrase, school_year: CURRENT_YEAR, credit_date: Date.new(CURRENT_YEAR + 1, 6, 15)
